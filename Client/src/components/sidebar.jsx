  ...
  return (
    <div className="border-r h-screen w-1/4 pt-5">
      <div className="mb-5">
        ...
        <span>Obafemi Awolowo University</span> <br />
      ...
      <ul className="">
        ...
        <li className="py-6 hover:border-r-4 hover:font-light text-left pl-10 hover:text-[#113885] hover:border-r-[#113885] cursor-pointer hover:bg-[#CFDEFD]">
          <a href="/bedspace" className="flex gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
        ...
        <li className="py-6 hover:border-r-4 hover:font-light text-left pl-10 hover:text-[#113885] hover:border-r-[#113885] cursor-pointer hover:bg-[#CFDEFD]">
          <a href="/report" className="flex gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
        ...
        <li className="py-6 hover:border-r-4 hover:font-light text-left pl-10 hover:text-[#113885] hover:border-r-[#113885] cursor-pointer hover:bg-[#CFDEFD]">
          <a href="/payment" className="flex gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
        ...
        <li className="py-6 text-left pl-10 hover:font-light hover:bg-red-100 hover:text-red-500 cursor-pointer">
          <a href="/logout" className="flex gap-3">
            {" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
